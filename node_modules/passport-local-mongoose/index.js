...
module.exports = function (schema, options) {
  ...
  options.errorMessages.MissingUsernameError = options.errorMessages.MissingUsernameError || 'No username was given'; 'A user with the given username is already registered';
